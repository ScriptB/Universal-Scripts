...
print("UNC Security Check - Executor: " .. tostring(identifyexecutor()) .. "\nInspired by the UNC Environment Check!\n")
print(" - Pass, - Fail, - Unknown")
...
print("\n")
print("UNC Security Check Summary - " .. tostring(identifyexecutor()))
print("✅ Tested with a " .. rate .. "% security mitigations rate (" .. outOf .. ")")
