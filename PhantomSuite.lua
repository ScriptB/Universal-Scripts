...
task.spawn(function()
	...
	local function smooth(from, to)
		-- Convert 1-10 scale to 0.1-0.9 smoothing factor (reversed)
		-- 1 = strong (0.1 smoothing, 90% movement) - HIGH movement
		-- 10 = subtle (0.9 smoothing, 10% movement) - LOW movement
